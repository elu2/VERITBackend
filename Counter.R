...
counted_df <- sqldf("SELECT INPUT, OUTPUT, CONTROLLER, EVENT_LABEL, COUNT(*) AS COUNTER, SEEN_IN FROM uncounted GROUP BY OUTPUT_ID, CONTROLLER_ID, EVENT_LABEL ORDER BY COUNTER DESC")
